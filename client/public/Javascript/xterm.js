				...
				function (e, t, i) {
					...
					var s =
						...
						(o.prototype.getWrappedRangeForLine = function (e) {
							for (var t = e, i = e; 0 < t && this.lines.get(t).isWrapped; )
								t--;
							for (
								;
					...
					var r = e("./MouseHelper"),
						...
						u =
							...
							(f.prototype._selectWordAt = function (e, t) {
								...
								if (i) {
									for (; i.start < 0; )
										(i.start += this._terminal.cols), e[1]--;
									...
									g.isLinux &&
										this.register(
											C.addDisposableDomListener(
												...
												function (e) {
													1 === e.button &&
														u.moveTextAreaUnderMouseCursor(e, t);
												}
											)
										);
							}),
						...
						c =
							...
							(u.prototype.setFromCharData = function (e) {
								...
								t &&
									...
									(this.content =
										2097152 | (e[o.CHAR_DATA_WIDTH_INDEX] << 22)));
							}),
					...
					var o,
						...
						l =
							...
							(h.prototype._isOverlapping = function (e) {
								...
								return (
									this._ctx.restore(), (this._characterOverlapCache[t] = i)
								);
							}),
							h);
					function h(e, t, i, r, n) {
							...
							for (h = 0; h < l; h++) {
								...
								if (0 !== c) {
									...
									if (this._workCell.isFgRGB()) {
										...
										f &&
											u.classList.add("xterm-bg-" + m.INVERTED_DEFAULT_COLOR);
